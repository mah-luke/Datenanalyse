...
Wie ersichtlich ist, folgt die Lowess Kurve mit der Spannweite `r spans[1, 1]` einem jährlichen Zyklus (ein lokales min / max pro Jahr), während die Lowess Kurve mit der Spannweite von `r spans[2, 1]`
